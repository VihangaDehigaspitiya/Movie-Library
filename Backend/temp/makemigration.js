...
let ts = `${date_now.getFullYear()}${format_numbers(date_now.getMonth()+1)}${format_numbers(date_now.getDate())}${format_numbers(date_now.getHours())}${format_numbers(date_now.getMinutes())}${format_numbers(date_now.getSeconds())}`
let file_name = `${ts}-${currentState.revision}`;

// write migration to file
let info = migrate.writeMigration(file_name,
               migration,
               migrationsDir,
